...
#line 1523 "grammar.c"
  ...
  case 4:
#line 129 "grammar.y"
             { (yyval.class_list) = parser->ast.AddNode(std::make_unique<ASTNode_Class_List>()); }
#line 1529 "grammar.c"
    break;

  case 5:
#line 132 "grammar.y"
                                                                               { (yyval.clazz) = parser->ast.AddNode(std::make_unique<ASTNode_Class>((yyvsp[-4].id), (yyvsp[-2].member_declaration_list))); }
#line 1535 "grammar.c"
    break;

  case 6:
#line 133 "grammar.y"
                                                                                                    { (yyval.clazz) = parser->ast.AddNode(std::make_unique<ASTNode_Class_Child>((yyvsp[-6].id), (yyvsp[-4].id), (yyvsp[-2].member_declaration_list))); }
#line 1541 "grammar.c"
    break;

  case 7:
#line 136 "grammar.y"
                      { (yyval.member_declaration) = parser->ast.AddNode(std::make_unique<ASTNode_MemberDeclaration_Variable>((yyvsp[-2].type), (yyvsp[-1].id))); }
#line 1547 "grammar.c"
    break;

  case 8:
#line 137 "grammar.y"
                                                                                                     { (yyval.member_declaration) = parser->ast.AddNode(std::make_unique<ASTNode_MemberDeclaration_Function>((yyvsp[-7].type), (yyvsp[-4].formals), (yyvsp[-6].id), (yyvsp[-1].body))); }
#line 1553 "grammar.c"
    break;

  case 9:
#line 138 "grammar.y"
                                                                                                { (yyval.member_declaration) = parser->ast.AddNode(std::make_unique<ASTNode_MemberDeclaration_Constructor>((yyvsp[-4].formals), (yyvsp[-6].id), (yyvsp[-1].body))); }
#line 1559 "grammar.c"
    break;
...
#line 1565 "grammar.c"
  ...
  case 11:
#line 142 "grammar.y"
             { (yyval.member_declaration_list) = parser->ast.AddNode(std::make_unique<ASTNode_MemberDeclaration_List>()); }
#line 1571 "grammar.c"
    break;

  case 12:
#line 145 "grammar.y"
                   { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_ExprOnly>((yyvsp[-1].expr))); }
#line 1577 "grammar.c"
    break;

  case 13:
#line 147 "grammar.y"
                        { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_VariableDeclaration>((yyvsp[-2].type), (yyvsp[-1].id))); }
#line 1583 "grammar.c"
    break;

  case 14:
#line 163 "grammar.y"
                                   { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_Assignment>((yyvsp[-3].lvalue), (yyvsp[-1].expr))); }
#line 1589 "grammar.c"
    break;

  case 15:
#line 165 "grammar.y"
                                                                   { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_If>((yyvsp[-2].expr), (yyvsp[0].statement))); }
#line 1595 "grammar.c"
    break;

  case 16:
#line 166 "grammar.y"
                                                                                          { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_IfElse>((yyvsp[-4].expr), (yyvsp[-2].statement), (yyvsp[0].statement))); }
#line 1601 "grammar.c"
    break;

  case 17:
#line 168 "grammar.y"
                                                                      { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_While>((yyvsp[-2].expr), (yyvsp[0].statement))); }
#line 1607 "grammar.c"
    break;
...
#line 1613 "grammar.c"
  ...
  case 19:
#line 171 "grammar.y"
                                    { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_Return>((yyvsp[-1].expr))); }
#line 1619 "grammar.c"
    break;

  case 20:
#line 172 "grammar.y"
                { (yyval.statement) = parser->ast.AddNode(std::make_unique<ASTNode_Statement_Empty>()); }
#line 1625 "grammar.c"
    break;
...
#line 1661 "grammar.c"
  ...
  case 27:
#line 187 "grammar.y"
                    { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Times>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1667 "grammar.c"
    break;

  case 28:
#line 188 "grammar.y"
                       { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Divide>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1673 "grammar.c"
    break;

  case 29:
#line 189 "grammar.y"
                     { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Plus>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1679 "grammar.c"
    break;

  case 30:
#line 190 "grammar.y"
                      { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Minus>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1685 "grammar.c"
    break;

  case 31:
#line 191 "grammar.y"
                                              { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Parenthesis>((yyvsp[-1].expr))); }
#line 1691 "grammar.c"
    break;

  case 32:
#line 192 "grammar.y"
                    { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_And>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1697 "grammar.c"
    break;

  case 33:
#line 193 "grammar.y"
                   { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Or>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1703 "grammar.c"
    break;

  case 34:
#line 194 "grammar.y"
                           { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Equivalent>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1709 "grammar.c"
    break;

  case 35:
#line 195 "grammar.y"
                             { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_IsNotEqual>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1715 "grammar.c"
    break;

  case 36:
#line 196 "grammar.y"
                                   { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_LessThanOrEqual>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1721 "grammar.c"
    break;

  case 37:
#line 197 "grammar.y"
                          { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_LessThan>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1727 "grammar.c"
    break;

  case 38:
#line 198 "grammar.y"
                                      { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_GreaterThanOrEqual>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1733 "grammar.c"
    break;

  case 39:
#line 199 "grammar.y"
                             { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_GreaterThan>((yyvsp[-2].expr), (yyvsp[0].expr))); }
#line 1739 "grammar.c"
    break;

  case 40:
#line 201 "grammar.y"
                 { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_UnaryMinus>((yyvsp[0].expr))); }
#line 1745 "grammar.c"
    break;

  case 41:
#line 202 "grammar.y"
                  { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_BooleanNegate>((yyvsp[0].expr))); }
#line 1751 "grammar.c"
    break;

  case 42:
#line 204 "grammar.y"
              { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Integer>((yyvsp[0].val))); }
#line 1757 "grammar.c"
    break;

  case 43:
#line 206 "grammar.y"
                   { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_Boolean>((yyvsp[0].val))); }
#line 1763 "grammar.c"
    break;
...
#line 1769 "grammar.c"
  ...
  case 45:
#line 209 "grammar.y"
                                                                { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_New_Obj>((yyvsp[-1].actual), (yyvsp[-3].id))); }
#line 1775 "grammar.c"
    break;

  case 46:
#line 224 "grammar.y"
                                                     { (yyval.expr) = parser->ast.AddNode(std::make_unique<ASTNode_Expr_New_Array>((yyvsp[-3].type), (yyvsp[-1].expr))); }
#line 1781 "grammar.c"
    break;
...
#line 1787 "grammar.c"
  ...
  case 48:
#line 229 "grammar.y"
       { (yyval.lvalue) = parser->ast.AddNode(std::make_unique<ASTNode_LValue_ID>((yyvsp[0].id))); }
#line 1793 "grammar.c"
    break;

  case 49:
#line 230 "grammar.y"
                                                    { (yyval.lvalue) = parser->ast.AddNode(std::make_unique<ASTNode_LValue_MethodCall>((yyvsp[-1].actual), (yyvsp[-3].id))); }
#line 1799 "grammar.c"
    break;

  case 50:
#line 232 "grammar.y"
                                           { (yyval.lvalue) = parser->ast.AddNode(std::make_unique<ASTNode_LValue_Array>((yyvsp[-3].lvalue), (yyvsp[-1].expr))); }
#line 1805 "grammar.c"
    break;

  case 51:
#line 234 "grammar.y"
                    { (yyval.lvalue) = parser->ast.AddNode(std::make_unique<ASTNode_LValue_Obj_Access>((yyvsp[-2].lvalue), (yyvsp[0].id))); }
#line 1811 "grammar.c"
    break;

  case 52:
#line 235 "grammar.y"
                                                               { (yyval.lvalue) = parser->ast.AddNode(std::make_unique<ASTNode_LValue_Obj_MethodCall> ((yyvsp[-5].lvalue), (yyvsp[-3].id), (yyvsp[-1].actual))); }
#line 1817 "grammar.c"
    break;

  case 53:
#line 237 "grammar.y"
                   { (yyval.lvalue) = parser->ast.AddNode(std::make_unique<ASTNode_LValue_This>()); }
#line 1823 "grammar.c"
    break;

  case 54:
#line 240 "grammar.y"
                { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_Int>()); }
#line 1829 "grammar.c"
    break;

  case 55:
#line 241 "grammar.y"
                   { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_Bool>()); }
#line 1835 "grammar.c"
    break;

  case 56:
#line 242 "grammar.y"
                   { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_Void>()); }
#line 1841 "grammar.c"
    break;

  case 57:
#line 243 "grammar.y"
         { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_ID>((yyvsp[0].id))); }
#line 1847 "grammar.c"
    break;

  case 58:
#line 245 "grammar.y"
                              { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_Int_Array>()); }
#line 1853 "grammar.c"
    break;

  case 59:
#line 246 "grammar.y"
                               { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_Bool_Array>()); }
#line 1859 "grammar.c"
    break;

  case 60:
#line 247 "grammar.y"
                               { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_Void_Array>()); }
#line 1865 "grammar.c"
    break;

  case 61:
#line 248 "grammar.y"
                     { (yyval.type) = parser->ast.AddNode(std::make_unique<ASTNode_Type_ID_Array>((yyvsp[-1].id))); }
#line 1871 "grammar.c"
    break;

  case 62:
#line 252 "grammar.y"
            { (yyval.formal) = parser->ast.AddNode(std::make_unique<ASTNode_Formal>((yyvsp[-1].type), (yyvsp[0].id))); }
#line 1877 "grammar.c"
    break;
...
#line 1883 "grammar.c"
  ...
  case 64:
#line 256 "grammar.y"
             { (yyval.formals) = parser->ast.AddNode(std::make_unique<ASTNode_Formal_List>()); }
#line 1889 "grammar.c"
    break;
