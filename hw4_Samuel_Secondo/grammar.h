...
#line 8 "grammar.y"
    ...
    std::shared_ptr<ASTNode_Expr> expr;
    std::shared_ptr<ASTNode_Statement> statement;

    std::shared_ptr<ASTNode_Actuals> actual;
    std::shared_ptr<ASTNode_Statement_Body> body;

    std::shared_ptr<ASTNode_LValue> lvalue;
